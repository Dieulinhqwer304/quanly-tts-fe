...
5. Cấu hình email:
    - Xem trước nội dung email (Sử dụng mẫu mặc định của SV Technologies)
    - **Chỉnh sửa**: Có thể click vào nội dung email để chỉnh sửa trực tiếp nếu cần.
    - Tiêu đề email: "Offer for Trainee Period - [Vị trí]"
    - Kiểm tra các trường thông tin trong bản xem trước.
