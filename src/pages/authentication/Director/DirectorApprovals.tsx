        ...
        <Layout style={{ height: 'calc(100vh - 64px)', background: '#f6f7f8' }}>
            <Sider width={400} theme='light' style={{ borderRight: '1px solid #e5e7eb', overflowY: 'auto' }}>
                <div style={{ padding: '16px', borderBottom: '1px solid #e5e7eb' }}>
                    ...
                    >
                        ...
                        <Space>
                            <Button size='small' type='text' style={{ background: '#f0f2f4' }}>
                                Pending
                            </Button>
                    ...
                    <Input prefix={<SearchOutlined />} placeholder='Search requests...' />
                </div>
                <List
            ...
            <Content style={{ padding: 0, overflowY: 'auto', position: 'relative' }}>
                ...
                >
                    ...
                    <Tag color='warning' style={{ fontSize: '14px', padding: '4px 12px', borderRadius: '16px' }}>
                        Pending Review
                    </Tag>
                </div>
                ...
                <div style={{ padding: '32px', paddingBottom: '120px', maxWidth: '1000px', margin: '0 auto' }}>
                    <Row gutter={24}>
                        <Col span={16}>
                            <Card
                                bordered={false}
                                style={{ marginBottom: '24px', borderRadius: '12px', border: '1px solid #e5e7eb' }}
                            >
                                <Title
                                    level={5}
                            ...
                            >
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                    <div>
                                        ...
                                        <Progress percent={90} showInfo={false} size='small' strokeColor='#136dec' />
                                    </div>
                                    <div>
                                        <div
                                            style={{
                                        ...
                                        <Progress percent={85} showInfo={false} size='small' strokeColor='#136dec' />
                                    </div>
                                    <div>
                                        <div
                                            style={{
                                        ...
                                        <Progress percent={95} showInfo={false} size='small' strokeColor='#10b981' />
                                    </div>
                                </div>
                            </Card>
                        </Col>
                    ...
                    <Row gutter={24}>
                        ...
                        <Col span={12}>
                            ...
                            >
                                ...
                                <div style={{ position: 'relative', paddingLeft: '16px', marginBottom: '16px' }}>
                                    <span
                                        style={{
                                            position: 'absolute',
                                            left: 0,
                                    ...
                                    <Paragraph style={{ fontStyle: 'italic', color: '#4b5563', lineHeight: 1.6 }}>
                                        Alex has consistently exceeded expectations in the Q3 migration project. He not
                                        only handled his assigned tickets but also proactively fixed legacy bugs in the
                                        payment gateway. His technical aptitude matches that of a Junior II level,
                                        justifying the slightly higher starting salary. Losing him would be a setback
                                        for the team velocity.
                                    </Paragraph>
                                </div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <Space>
                                ...
                                <Button icon={<HistoryOutlined />}>Request Adjustment</Button>
                                <Button type='primary' icon={<CheckCircleOutlined />} style={{ background: '#136dec' }}>
                                    Approve Request
                                </Button>
                            </Space>
                        </div>
