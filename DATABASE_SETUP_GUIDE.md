...
export DATABASE_URL="postgresql://tts_admin:your_password@localhost:5432/tts_learning"
...
```env
# Database
DATABASE_URL=postgresql://tts_admin:your_password@localhost:5432/tts_learning
DB_HOST=localhost
DB_PORT=5432
DB_NAME=tts_learning
DB_USER=tts_admin
